[![Run App  Khoa Tran](https://github.com/khoabin-star/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/khoabin-star/GithubActions/actions/workflows/run-app.yaml)
